  ...
  },
  {
    ...
    clues: [
      ...
      },
      {
        ...
        revelation: '🕵️ Case cracked! You\'ve identified the customers behind the revenue gap. The sales team was counting these as wins!'
      },
      {
        id: 4,
...
export function renderDetective() {
  ...
  <div class="page-header" style="text-align:center;margin-bottom:32px;">
    <div style="font-size:3.5rem;margin-bottom:8px;">🕵️‍♂️</div>
...
function runDetQuery() {
  ...
  if (!query) {
    resultsDiv.innerHTML = '<div class="feedback feedback-info"><span class="feedback-icon">ℹ️</span><span>Write a query first!</span></div>';
    return;
  }
