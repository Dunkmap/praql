  ...
  <div id="game-start-screen" style="max-width:600px;margin:0 auto;">
    <div class="card" style="text-align:center;padding:40px;">
      <div style="display:flex;justify-content:center;gap:24px;margin-bottom:28px;">
        <div class="card" style="padding:16px 24px;text-align:center;min-width:110px;">
          <div style="font-size:1.8rem;">🐛</div>
          <div style="font-weight:800;font-size:0.78rem;color:var(--text-muted);margin-top:4px;">Fix Bugs</div>
        </div>
        <div class="card" style="padding:16px 24px;text-align:center;min-width:110px;">
          <div style="font-size:1.8rem;">⏱</div>
          <div style="font-weight:800;font-size:0.78rem;color:var(--text-muted);margin-top:4px;">Timed</div>
        </div>
        <div class="card" style="padding:16px 24px;text-align:center;min-width:110px;">
          <div style="font-size:1.8rem;">🔥</div>
          <div style="font-weight:800;font-size:0.78rem;color:var(--text-muted);margin-top:4px;">Streaks</div>
        </div>
      </div>
...
function submitBugFix() {
  ...
  const fb = document.getElementById('game-feedback');
  if (!userQuery) {
    fb.innerHTML = '<div class="feedback feedback-info"><span class="feedback-icon">ℹ️</span><span>Write your fix first!</span></div>';
    return;
  }
